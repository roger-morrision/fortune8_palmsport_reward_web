...
export function useDefaultClassNames() {
  const classNames = {
    [UI.days]: '',
    [UI.day_cell]: 'p-0.5',
    ...
    [UI.month_label]: 'web:whitespace-nowrap text-foreground group-active:text-accent-foreground font-normal',
    [UI.years]: '',
    [UI.year]: 'group rounded-md web:hover:bg-accent active:bg-accent',
    [UI.year_label]: 'web:whitespace-nowrap text-foreground group-active:text-accent-foreground font-normal',
    ...
    [SelectionState.selected]: 'group bg-primary web:hover:bg-primary web:hover:opacity-90 active:opacity-90',
    ...
    [MonthState.selected_month]: 'group bg-primary web:hover:bg-primary web:hover:opacity-90 active:opacity-90',
    [MonthState.selected_month_label]: 'text-primary-foreground',
    [YearState.selected_year]: 'group bg-primary web:hover:bg-primary web:hover:opacity-90 active:opacity-90',
...
export function useDefaultStyles(scheme) {
